...
const CVHeader = ({ data, plainImg = false }) => {
  return (
    <div className="cv-header text-center">
      ...
      <div className="cv-photo-wrap relative mb-4 flex justify-center">
        <div className="cv-photo relative w-40 h-40 rounded-full border-4 border-blue-500 shadow-lg overflow-hidden flex items-center justify-center">
          {plainImg ? (
      ...
      {/* Name */}
      <h1 className="cv-name text-xl font-bold text-gray-800 mb-2 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
        {data.name}
      </h1>
      ...
      {data.headline ? (
        <div className="cv-headline mb-4 px-2">
          <p className="cv-role text-base font-bold text-blue-600 leading-tight mb-0.5">
            {data.headline.split("\n")[0]}
          </p>
          <p className="cv-role-subtitle text-xs text-gray-600 font-medium leading-relaxed">
            {data.headline.split("\n")[1]}
          </p>
        </div>
      ) : (
      ...
      <div className="cv-contact-list space-y-2 text-xs text-gray-700">
        <div className="cv-contact-row flex items-center gap-2">
