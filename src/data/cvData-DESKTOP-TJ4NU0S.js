...
const itSupportData = {
  ...
  techSkills: [
    // First-line IT Support daily tools — shown first to catch fast-scanning managers
    {
      name: "ServiceNow",
      level: "Intermediate",
...
const cvData = {
  ...
  headline: selectedData.headline || null,
};
